...
namespace RobotRampage
{
    class Enemy
    {
        ...
        public Enemy(Vector2 worldLocation, Texture2D texture, Rectangle initialFrame)
        {
            ...
            EnemyBase.CollisionRadius = collisonRadius;
        ...
        {
            List<Vector2> path = PathFinder.FindPath(TileMap.GetSquareAtPixel(EnemyBase.WorldCenter),
